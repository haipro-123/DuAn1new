...
import javaapplication24.service.impl.GioHangViewService;
import javaapplication24.service.impl.HoaDonViewService;
...
public class BanHangView extends javax.swing.JPanel implements Runnable, ThreadFactory {
    ...
    HoaDonViewService hdvs = new HoaDonViewService();
    GioHangViewService ghvs = new GioHangViewService();
    List<HoaDonViewModel> listhdv = new ArrayList();
    List<GioHangViewModel> listghv = new ArrayList();
    ...
    public BanHangView() {
        initComponents();
        initWebcam();
        listghv = ghvs.getList();
        listhdv = hdvs.getList();
    ...
    private void initComponents() {
        ...
        tblHoaDonView.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "IdHoaDon", "NgayTao", "NhanVien", "sdtKhachHang"
            }
        ) {
